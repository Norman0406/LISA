...
enum Columns { NameColumn, LoadedColumn, VersionColumn, AuthorsColumn, };
    ...
    : QWidget(parent)
{
    ...
    m_model->setHeader(QStringList() << tr("Name") << tr("Load") << tr("Version") << tr("Authors"));
