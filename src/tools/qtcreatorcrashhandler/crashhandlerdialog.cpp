...
static const char SettingsApplication[] = "LISA";
...
{
    const QString ideName = QLatin1String("LISA");
    ...
    QString revision;
#ifdef LISA_REVISION
     revision = QLatin1Char(' ') + tr("from revision %1").arg(QString::fromLatin1(Core::Constants::LISA_REVISION_STR).left(10));
#endif
    const QString versionInformation = tr(
        "%1 %2%3, based on Qt %4 (%5 bit)\n")
            .arg(ideName, QLatin1String(Core::Constants::LISA_VERSION_LONG), revision,
