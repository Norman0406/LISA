...
QString ICore::versionString()
{
    ...
    ideVersionDescription = tr(" (%1)").arg(QLatin1String(Constants::LISA_VERSION_DESCRIPTION_STR));
#endif
    return tr("LISA %1%2").arg(QLatin1String(Constants::LISA_VERSION_LONG),
