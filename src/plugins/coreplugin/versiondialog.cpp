    ...
    : QDialog(parent)
{
    ...
    QString rev;
     ...
     rev = tr("From revision %1<br/>").arg(QString::fromLatin1(Constants::LISA_REVISION_STR).left(10));
#endif
     QString buildDateInfo;
#ifdef LISA_SHOW_BUILD_DATE
     ...
     const QString description = tr(
        ...
        .arg(ICore::versionString(),
             ...
             buildDateInfo,
             rev,
             QLatin1String(Constants::LISA_FIRSTYEAR),
             QLatin1String(Constants::LISA_YEAR),
             QLatin1String(Constants::LISA_AUTHORS));
