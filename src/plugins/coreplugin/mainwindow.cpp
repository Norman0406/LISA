    ...
    m_toggleSideBarButton(new QToolButton)
{
    ...
    setWindowTitle(tr("LISA - Lightweight Integrated System for Amateur Radio"));
    ...
    QCoreApplication::setApplicationVersion(QLatin1String(Core::Constants::LISA_VERSION_LONG));
